document.addEventListener("DOMContentLoaded", () => {
            ...
            <ul>
              ${details.participants.map((participant) => `
                <li>
                  ...
                  <button class="participant-remove" type="button" data-email="${participant}" title="Unregister ${participant}" aria-label="Unregister ${participant}">&#128465;</button>
                </li>
              `).join("")}
            </ul>
          </div>
  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    try {
      ...
      const participantCount = activityCard.querySelectorAll(".participants li").length;
